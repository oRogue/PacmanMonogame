...
{
    // This extension is taken (with minor changes) from https://github.com/DoogeJ/MonoGame.Primitives2D/blob/master/Primitives2D.cs
    // DrawVerticalLine() method is inspired by https://community.monogame.net/t/line-drawing/6962/5
    ...
    public static class SpriteBatchExtensions
    {
                                           ...
                                           , Color color, float thickness = 1f)
        {
            ...
            CreateThePixel(spriteBatch);
            spriteBatch.Draw(pixel, position, null, color, 0.0f, origin, scale, SpriteEffects.None, 0);
        }
